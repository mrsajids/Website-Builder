...
// import WordAnimator from "../components/WorkTypeChanger";
import { useNavigate } from "react-router-dom";
import WordAnimator from "../components/WorkTypeChanger";

const Landing = () => {
  const words = ["Hello", "Welcome", "No Code", "No Limits", "Just Create"];
  ...
  return (
    <div>
      ...
      {/*====== HEADER PART START ======*/}
      <header className="header-area animate__animated animate__fadeIn animate__delay-1s">
        {/* navbar area */}
          ...
          <div className="row justify-content-center">
            ...
            <div className="col-lg-4 col-md-7 col-sm-8">
              ...
              >
                ...
                <div className="services-content mt-30">
                  <h4 className="services-title">
                    <a href="#">Built-in SEO Tools</a>
                  </h4>
                  <p className="text">Rank higher and get discovered faster.</p>
                  <a className="more" href="#">
                    Learn More <i className="lni lni-chevron-right"> </i>
                  </a>
                </div>
          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-6">
                <AnimateDiv animationClass="animate__animated animate__bounceInLeft">
                  <div
              ...
              <div className="col-lg-6">
                <AnimateDiv animationClass="animate__animated animate__bounceInRight">
                  <div
          ...
          <div className="container">
            <div className="row align-items-center">
              <div className="col-lg-6 order-lg-last">
                <AnimateDiv animationClass="animate__animated animate__backInLeft">
                  <div
              ...
              <div className="col-lg-6 order-lg-first">
                <AnimateDiv animationClass="animate__animated animate__backInRight">
                  <div
                    className="about-image text-center mt-50 wow fadeInRightBig"
                    data-wow-duration="1s"
                    data-wow-delay="0.5s"
            ...
            <div className="row">
              <div className="col-lg-4 col-md-6 col-sm-8">
                ...
                >
                  ...
                  <p className="text">
                    Create stunning websites with zero coding. Whether you're a
                    creator, business owner, or entrepreneur, our powerful
                    builder helps you go live — in minutes.
                  </p>
                  <ul className="social">
                    <li>
                      <a
