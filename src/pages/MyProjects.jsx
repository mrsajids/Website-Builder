    ...
    <>
      ...
      <Row gutter={[24, 24]}>
        {projects.map((project) => (
          <Col xs={24} sm={12} md={8} lg={6} key={project.id}>
            <div
              class="card card-hover overflow-hidden fancy-card"
            ...
            >
              ...
              <div class="card-body pb-1">
                ...
                <div class="d-flex gap-2 text-muted">
                  <p class="mb-0 time-text">1 day ago</p>
              ...
              <div class="card-footer bg-light d-flex justify-content-end  gap-2 p-2 border-0">
                {/* <button className="btn btn-primary-outline p-1">
                  <MdDelete key="delete" style={{ color: "purple" }} />
                </button> */}
                <Popconfirm
                  title="Are you sure to delete this project?"
                  onConfirm={(e) => {
                ...
                >
                  <Button
                    ...
                    size="small"
                    icon={
                      <MdDelete key="edit" style={{ color: "rgb(66 66 66)" }} />
                    }
                  />
                </Popconfirm>
                ...
                <Button
                  ...
                  color="rgb(66 66 66)"
                  icon={
                    <FaEdit key="edit" style={{ color: "rgb(66 66 66)" }} />
                  }
                  className="me-2"
                  onClick={(e) => {
                    e.stopPropagation(); // prevent opening detail view
                ...
                <div class="d-flex gap-2 align-items-center">
                  ...
                  <span>27 Nov 2024 - 5 Mar 2025</span>
                </div>
                <div class="d-flex gap-2 align-items-center">
        ...
        <Form form={form} layout="vertical" name="projectForm">
          <Form.Item
            ...
            rules={[{ required: true, message: "Please enter a project name" },
              ...
              { pattern: /^[a-zA-Z0-9\s]+$/, message: "Project name can only contain letters, numbers, and spaces"}
            ]}
          >
            <Input />
          </Form.Item>
